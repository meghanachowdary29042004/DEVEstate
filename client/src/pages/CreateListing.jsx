...
export default function CreateListing() {
  ...
  const handleChange = (e) => {
    if (e.target.id === 'sale' || e.target.id === 'rent' || e.target.id === 'shared') {
      setFormData({
        ...formData,
        type: e.target.id,
      });
  ...
  return (
    <div className='bg-gray-900'>
      <main className='bg-gray-900 text-white p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
          <div className='flex flex-col gap-4 flex-1'>
            <input
              type='text'
              placeholder='Name'
              className='bg-gray-800 text-white border p-3 rounded-lg'
              id='name'
              maxLength='62'
              minLength='10'
              required
              ...
              {formData.type === 'shared' && (
                <div className='flex flex-col gap-4 '>
                  ...
                  <input
                    ...
                    id='tenantsFilled'
                    min='0'
                    max={formData.tenantsneed}
                    required
                    className='p-3 border border-gray-300 text-black
 rounded-lg'
                    onChange={handleChange}
                    value={formData.tenantsFilled}
                  />
                  <p>Tenants filled</p>

                  <input
                    type='text'
                    id='tenantOccupations'
                    required
                    className='p-3 border border-gray-300  text-black
 rounded-lg'
                    onChange={handleChange}
                    value={formData.tenantOccupations}
                  />
                  <p>Tenant Occupations</p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-10 mt-16">
        <div className="w-full px-6 flex flex-col sm:flex-row justify-between items-center gap-6 max-w-7xl mx-auto">
          <div className="text-center sm:text-left">
            ...
            <p className="text-base">Find your perfect place to live or share.</p>
          </div>
