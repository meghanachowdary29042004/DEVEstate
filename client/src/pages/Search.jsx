...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const tenantOccupationFromUrl = urlParams.get('tenantOccupation');
    ...
    if (
      ...
      setSidebardata({
        ...
        tenantOccupation: tenantOccupationFromUrl || '',
      });
    }
  ...
  const handleChange = (e) => {
    if (
      e.target.id === 'all' ||
      e.target.id === 'rent' ||
      e.target.id === 'sale' || e.target.id === 'shared' 
    ...
    if (e.target.id === 'tenantOccupation') {
      setSidebardata({ ...sidebardata, tenantOccupation: e.target.value });
    }
  ...
  const handleSubmit = (e) => {
    ...
    urlParams.set('tenantOccupation', sidebardata.tenantOccupation);
  ...
  return (
    <div className='flex   bg-gray-900 flex-col md:flex-row'>
  ...
  <input
    ...
    className='border rounded-lg p-3 w-full'
    value={sidebardata.tenantOccupation}
    onChange={handleChange}
  />
</div>
